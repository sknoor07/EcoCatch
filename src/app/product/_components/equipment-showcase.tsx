          ...
          {categories.map((cat, i) => {
            ...
            return (
              <ScrollReveal key={cat.slug} delay={i * 0.1}>
                <div className="group relative overflow-hidden rounded-2xl border border-[#1A1A1A]/5 dark:border-[#E5E5E5]/5 bg-white dark:bg-[#111] p-6 transition-all hover:shadow-lg">
